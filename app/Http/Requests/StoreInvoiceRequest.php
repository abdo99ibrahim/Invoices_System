...
class StoreInvoiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'Total'=>'required',
            'note'=>'required',
            'pic'=>'required|mimes:png,jpg,jpeg,csv,txt,xlx,xls,pdf|max:2048'
        ];
    }
    public function messages()
{
    return [
        ...
        'pic.required' => 'يجب رفع مرفقات',
        'pic.mimes' => 'png,jpg,jpeg,csv,txt,xlx,xls,pdf يجب أن يكون المرفق يحتوي على الصيغ الأتية',
